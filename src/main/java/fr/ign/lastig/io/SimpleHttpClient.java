...
public class SimpleHttpClient {
   ...
   */
  public void connect(String method, String contentType, String encoding) throws Exception {
    try {
      ...
      server.setRequestProperty  ("Authorization", "Basic " + encoding);
...
//  }
  ...
  public void post(String content) throws Exception {
    try {
      ...
      //File fic1 = new File("./img/chenaie.png");
      //FileInputStream fileInputStream = new FileInputStream(fic1);
